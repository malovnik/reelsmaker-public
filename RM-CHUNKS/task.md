...
> **Рабочая папка pipeline:** `/Users/malovnik/Documents/Dev/videomaker/RM-CHUNKS/`
...
| Путь | Роль |
|------|------|
| `/Users/malovnik/Documents/Dev/videomaker/` | Корень проекта, monorepo. |
...
Корневая папка: `/Users/malovnik/Documents/Dev/videomaker/RM-CHUNKS/`
...
| Ralph Loop (local fork) | `/Users/malovnik/Documents/malovnik-obsidian/🤖 ИИ/Софт/looper-tmux` — команда `/ralph-loop-local:ralph-loop`. |
