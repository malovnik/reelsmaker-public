...
| 1 | Аудит всех функций и ручек бэкенда | 5 swarm | agent-reports/ | ⏳ |
| 1b | Что реально подключено vs заглушки | 5 swarm | STUB-REALITY-MAP.md | ⬜ |
| 1b-fix | Оркестрация доводки заглушек | N | — | ⬜ |
| 2 | Консолидация → 3 агента пишут карту софта | 3 | BACKEND-MAP.md | ⬜ |
| 3 | Что сейчас выведено во фронтенд | 3 | FRONTEND-EXPOSURE.md | ⬜ |
